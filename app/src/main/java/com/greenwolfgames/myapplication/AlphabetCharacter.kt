    ...
    companion object
    {
        ...
        fun getAlphabetLetter(index: Int): AlphabetCharacter
        {
            return when (index)
            {
                ...
                2 -> AlphabetCharacter(2,"1","aan","Long a is in \'father\'", ECharacterSoundType.VOWEL)
                3 -> AlphabetCharacter(3,"4","hah","Long a is in \'father\'(alternate)", ECharacterSoundType.VOWEL)
                ...
                7 -> AlphabetCharacter(7, "2","hei","long ei as in \'why\'", ECharacterSoundType.CONSONANT)
                8 -> AlphabetCharacter(8,"9","hey","long ey as in \'hey\'", ECharacterSoundType.CONSONANT)
                ...
                13 -> AlphabetCharacter(13,"3","kii","ee as in \'see\'", ECharacterSoundType.VOWEL)
                14 -> AlphabetCharacter(14, "7","hir","ea as in \'hear\'", ECharacterSoundType.VOWEL)
                ...
                21 -> AlphabetCharacter(21,"8","thoor","long o as in \'lore\'", ECharacterSoundType.VOWEL)
                ...
                28 -> AlphabetCharacter(28,"5","huul","oo in \'fool\'", ECharacterSoundType.VOWEL)
                29 -> AlphabetCharacter(29,"6","nur","ure as in \'lure\'", ECharacterSoundType.VOWEL)
